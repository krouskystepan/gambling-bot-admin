    ...
    <Card className="py-4">
      <CardContent>
        <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-stretch lg:gap-6">
          ...
          <div className="grid min-w-0 flex-1 grid-cols-2 gap-x-4 gap-y-4 border-t border-border pt-4 sm:grid-cols-3 lg:flex-6 lg:grid-cols-7 lg:border-t-0 lg:pt-0">
